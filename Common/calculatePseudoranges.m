function [pseudoranges,transmitTime,localTime,dopplers] = ...
...
dopplers = inf(1, settings.numberOfChannels); % --sbs
...
for channelNr = channelList
    ...
    %% calculate the Doppler measurement [m/s] --sbs
    % Constants
    f_L1 = 1.57542e9; % L1 GPS frequency (Hz)   %(TODO:--sbs) this is dangerous
    ...
    dopplers(channelNr) = -(carrFreq - settings.IF) * settings.c / f_L1;   % m/s
