function [satPositions, satClkCorr, satVelocity, satClkCorrRat] = satpos(transmitTime, prnList,eph) 
...
%% The following is to calculate sv velocity (currently not used in this version)  try it --sbs
